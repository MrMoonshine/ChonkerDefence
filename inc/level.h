...
#define LEVEL_TILEMAP_TERRAIN_DIRT 3

#define LEVEL_TILEMAP_TERRAIN_GRASS_WIDTH (LEVEL_TILEMAP_TERRAIN_WIDTH - 1)
#define LEVEL_TILEMAP_TERRAIN_DIRT_POS (LEVEL_TILEMAP_TERRAIN_WIDTH - 1)
