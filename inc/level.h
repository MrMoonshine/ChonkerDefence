...
#define LEVEL_IS_LAND(node) (node == LEVEL_BLOCK_GRASS || LEVEL_BLOCK_DECORATION_LAND || node == LEVEL_BLOCK_CAT_2 || LEVEL_BLOCK_CAT_1)
...
#define LEVEL_TILEMAP_TERRAIN_HEIGHT 2
#define LEVEL_TILEMAP_TERRAIN_FILE "../build/test6.png"
